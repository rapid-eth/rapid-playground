...
var MinterEmblemForm = (_ref) => {
  ...
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Create a Minter Emblem"), _react.default.createElement("h3", null, "Number of contracts: ", contractsNum), _react.default.createElement(_designSystem.Form, {
    callback: onSubmit
    ...
    name: "field-three",
    placeholder: "Emblem Minters"
  }), _react.default.createElement(_designSystem.Button, {
    type: "submit"
  }, "Submit")));
};

var _default = MinterEmblemForm;
