...
var Transfer = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, props.label && _react.default.createElement(_designSystemAtoms.Heading, _extends({
    md: true
  ...
  }, styled), _react.default.createElement(_designSystemMolecules.Field, {
    name: "name",
    register: register,
    errors: errors,
    label: "Token Name",
  ...
  }, "Advanced Settings"), advanced && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystemMolecules.Field, {
    disabled: !advanced,
    name: "decimals",
    register: register,
    errors: errors,
  ...
  }, props.styledButton), deploying ? _react.default.createElement(_designSystemAtoms.Span, null, "Confirming...") : _react.default.createElement(_designSystemAtoms.Span, null, "Deploy ", !status.wallet && _react.default.createElement(_designSystemAtoms.Span, {
    xxs: true
  }, "Not Connected"), " ")), _react.default.createElement(_designSystemOrganisms.Toast, {
...
var _default = props => _react.default.createElement(_ethersReactSystem.EthersInject, null, _react.default.createElement(Transfer, props));
