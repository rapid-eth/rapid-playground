...
var ERC20BalanceOf = (_ref) => {
  ...
  return _react.default.createElement(_designSystemAtoms.Heading, styled, " ", props.label && _react.default.createElement(_designSystemAtoms.Span, props.styledLabel, props.label, ": "), " ", balanceOf);
};
...
var _default = props => _react.default.createElement(_ethersReactSystem.EthersInject, null, _react.default.createElement(ERC20BalanceOf, props));
