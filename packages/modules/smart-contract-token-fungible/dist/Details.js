...
var _ethersReactSystem = require("ethers-react-system");
...
var ERC20Details = (_ref) => {
  ...
  return {
    full: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystemAtoms.Heading, props.styled, _react.default.createElement(_designSystemAtoms.Span, props.styledLabel, props.label, ": "), _react.default.createElement(_designSystemAtoms.Span, {
      ml: 2
    }, name)), _react.default.createElement(_designSystemAtoms.Heading, props.styledSymbol, _react.default.createElement(_designSystemAtoms.Span, props.styledSymbolLabel, props.labelSymbol, ": "), _react.default.createElement(_designSystemAtoms.Span, {
      ml: 2
    }, symbol))),
    name: _react.default.createElement(_designSystemAtoms.Span, props.styled, name),
    symbol: _react.default.createElement(_designSystemAtoms.Span, props.styled, symbol)
  }[props.variant];
};
...
var _default = props => _react.default.createElement(_ethersReactSystem.EthersInject, null, _react.default.createElement(ERC20Details, props));
