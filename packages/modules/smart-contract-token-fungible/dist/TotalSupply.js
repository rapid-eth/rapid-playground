...
var ERC20TotalSupply = (_ref) => {
  ...
  return _react.default.createElement(_designSystemAtoms.Heading, styled, " ", _react.default.createElement(_designSystemAtoms.Span, props.styledLabel, props.label), ": ", totalSupply);
};
...
var _default = props => _react.default.createElement(_ethersReactSystem.EthersInject, null, _react.default.createElement(ERC20TotalSupply, props));
