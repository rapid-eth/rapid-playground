...
var TransferToast = props => {
  /* --- Component --- */
  return _react.default.createElement(_designSystemOrganisms.Toast, {
...
var Container = (_ref) => {
  ...
  return _react.default.createElement(_designSystemAtoms.Box, styled, _react.default.createElement(_BalanceOf.default, props));
};
