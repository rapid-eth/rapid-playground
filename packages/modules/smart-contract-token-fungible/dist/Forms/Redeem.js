...
var Redeem = (_ref) => {
  ...
  }, props.styledButton), deploying ? _react.default.createElement(_designSystemAtoms.Span, null, "Confirming...") : _react.default.createElement(_designSystemAtoms.Span, null, "Tranfser ", !status.contract && _react.default.createElement(_designSystemAtoms.Span, {
    xxs: true
  ...
  }, status.contractName ? _react.default.createElement(_designSystemAtoms.Span, {
    ml: 3
  }, _react.default.createElement(_designSystemAtoms.Span, {
    xxs: true,
    tag: "white"
  }, "INFO")) : _react.default.createElement(_designSystemAtoms.Span, {
    ml: 3
  }, _react.default.createElement(_designSystemAtoms.Span, {
    xxs: true,
    tag: "green"
...
var _default = props => _react.default.createElement(_ethersReactSystem.EthersInject, null, _react.default.createElement(Redeem, props));
