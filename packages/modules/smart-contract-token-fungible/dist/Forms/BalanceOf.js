...
var Transfer = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, props.label && _react.default.createElement(_designSystemAtoms.Heading, _extends({
    md: true
  }, props.styledLabel), props.label), _react.default.createElement(Box, null, _react.default.createElement(_designSystemAtoms.Heading, {
    sm: true,
    heavy: true
  }, "Amount:", _react.default.createElement(_designSystemAtoms.Span, {
    thin: true,
    ml: 2
  ...
  }, props.styledButton), _react.default.createElement(_designSystemAtoms.Span, null, "Lookup")), _react.default.createElement(_designSystemOrganisms.Toast, {
