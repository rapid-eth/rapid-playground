...
var MenuItem = (_ref) => {
  ...
  var [isOpen, setOpen] = (0, _react.useState)(true);
  var [sx, setStyle] = (0, _react.useState)({});
  ...
  }, isOpen ? '▶' : '▶'))))), isOpen && children && children.map((c, index) => _react.default.createElement(_designSystemAtoms.default.Flex, {
    column: true,
    key: index,
    sx: sxChild
  }, _react.default.createElement(WrapperLink, {
