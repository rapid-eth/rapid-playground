...
var PanelActions = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_reactTransitionGroup.CSSTransition, {
  ...
  }, _react.default.createElement(BackgroundGradient, {
    bg: "black",
    fixed: true,
    absolute: false,
    opacity: .2,
    ...
    timeout: 300,
    classNames: "fadeInLeft"
  }, !isOpening ? _react.default.createElement("div", null) : _react.default.createElement(_designSystemAtoms.Box, _extends({}, styled, styled), label && _react.default.createElement(_designSystemAtoms.Flex, _extends({
    alignCenter: true,
    between: true,
    fullWidth: true,
    gradient: "gray",
